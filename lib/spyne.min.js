...
*/
this.ViewStream=J,this.BasicView=P,this.DomEl=I,this.ViewStreamBroadcaster=k,this.ChannelsPayload=x,this.ChannelsController=Ee,this.ChannelsBase=te,this.ChannelPayloadItem=A,window.Spyne=this;let t={scrollLock:!1,scrollLockX:0,scrollLockY:0,debug:!1,channels:{WINDOW:{mediqQueries:{},events:[],listenForResize:!0,listenForOrientation:!0,listenForScroll:!1,listenForMouseWheel:!1,debounceMSTimeForResize:200,debounceMSTimeForScroll:150},ROUTE:{type:"slash",isHash:!1,isHidden:!1,routes:{routePath:{routeName:"change"}}}}};void 0!==e&&(window.Spyne.config=j(t,e)),this.getChannelActions=e=>window.Spyne.channels.getChannelActions(e),this.registerChannel=e=>this.channels.registerStream(e),this.registerDataChannel=e=>this.channels.registerStream(e),this.listChannels=()=>Array.from(window.Spyne.channels.map.keys());let r=new J({id:"spyne-null-views"});r.appendToDom(document.body),r.props.el.style.cssText="display:none; opacity:0; pointer-events:none;",this.channels.init()}static listChannels(){return Array.from(window.Spyne.channels.map.keys())}static getChannelActions(e){return window.Spyne.channels.getChannelActions(e)}static registerChannel(e){if(void 0!==window.Spyne)return window.Spyne.channels.registerStream(e);console.warn("Spyne has not been initialized")}}window.Spyne=Ne}])}));